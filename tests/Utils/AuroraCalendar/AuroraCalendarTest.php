...
class AuroraCalendarTest extends KernelTestCase
{
    ...
    {
        return [
            [28, new \DateTimeImmutable('2021-02-20')], // + 0 days before + 28 days + 0 days after
            [28, new \DateTime('2021-02-20')], // + 0 days before + 28 days + 0 days after
            [35, new \DateTimeImmutable('2022-12-31')], // + 3 days before + 31 days + 1 days after
            [35, new \DateTime('2022-12-31')], // + 3 days before + 31 days + 1 days after
            [35, new \DateTimeImmutable('2024-03-15')], // + 4 days before + 31 days + 0 days after
            [35, new \DateTime('2024-03-15')], // + 4 days before + 31 days + 0 days after
            [35, new \DateTimeImmutable('2024-04-01')], // + 0 days before + 30 days + 5 days after
