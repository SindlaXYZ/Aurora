...
use Sindla\Bundle\AuroraBundle\Utils\AuroraDiacritics\AuroraDiacritics;

/**
 * clear; php vendor/phpunit/phpunit.phar -c phpunit.xml.dist vendor/sindla/aurora/tests/Utils/AuroraDiacritics/DiacriticsTest.php --no-coverage
 */
