...
class LazyEntityCommand extends CommandMidleware
{
     ...
     *
     * Usage:
     *      clear; php bin/console borealis:lazy.entity --verbose --namespace=App --sonataAdmin=false --entity=Brand
     *      clear; php bin/console borealis:lazy.entity --verbose --namespace=App --sonataAdmin=true  --entity=Brand
     *
     * @var string
     */
    protected static $defaultName = 'borealis:lazy.entity';
...
{
    use \Sindla\Bundle\BorealisBundle\Repository\Traits\BaseRepository;
...
EOT;
    ...
    /**
     * Auto-generated file
     * This file is generated by running command [borealis:lazy.entity]
