...
class AuroraPHPUnitCodeCoverageBadge
{
    ...
    private function _PHPUnitTestsBadge(bool $isPassing): string
    {
        ...
        $colorA  = $isPassing ? '#34D058' : '#D73A49';
        $colorB  = $isPassing ? '#28A745' : '#CB2431';
        $textWidth = strlen($status) * 6.5;
        $backgroundWidth = 89;
    ...
    <g fill="none" fill-rule="evenodd">
        <g font-family="'DejaVu Sans',Verdana,Geneva,sans-serif" font-size="11">
            ...
            <text fill="#010101" fill-opacity=".3">
                <tspan x="22.1981982" y="15" aria-hidden="true">tests</tspan>
            </text>
            <text fill="#FFFFFF">
                <tspan x="22.1981982" y="14">tests</tspan>
            </text>
        </g>
        <g transform="translate(71)" font-family="'DejaVu Sans',Verdana,Geneva,sans-serif" font-size="11">
            ...
            <text fill="#010101" fill-opacity=".3" aria-hidden="true">
                <tspan x="{$centeredX}" y="15">{$status}</tspan>
            </text>
            <text fill="#FFFFFF">
                <tspan x="{$centeredX}" y="14">{$status}</tspan>
            </text>
        </g>
