...
yes | composer create-project symfony/skeleton:7.4.x-dev . --no-cache
...
yes | composer require sindla/aurora:7.4.x-dev -W --no-progress
...
echo -e "\n\nSymfony 7.4 installation completed.\n"
